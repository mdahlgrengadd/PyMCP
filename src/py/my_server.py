...
class MyService(McpServer):
    ...
    def resource_help(self) -> str:
        ...
        return """# MyService Help

Welcome to MyService! This is an MCP-compliant Python server.

## Available Tools:
- **echo(message, upper=False)**: Echo a message
- **add(a, b)**: Add two numbers
- **get_item(item_id)**: Fetch an item by ID

## Available Resources:
- **res://help**: This help document
- **res://stats**: Server statistics
- **res://doc/{doc_id}**: Get document by ID

## Available Prompts:
- **summarize**: Summarize a document
- **code_review**: Generate a code review prompt
"""
